...
// //       <h1
// //         className={`${cinzel.className} antialised text-4xl font-semibold text-black p-8`}
// //       >
// //         Idées de cadeaux...
// //       </h1>
...
// //           />
// //           <div
// //             className="absolute left-5 top-7 transform -translate-y-1/2 bg-yellow-400 text-white rounded-full px-3 py-3 
...
//     <div className="flex flex-col items-center justify-center mt-10">
//       <h1
//         className={`${cinzel.className} antialiased text-4xl font-semibold text-black p-8`}
//       >
//         Idées de cadeaux...
//       </h1>
...
//           />
//           <div
//             className="absolute left-5 top-7 transform -translate-y-1/2 bg-yellow-400 text-black rounded-full px-3 py-3 
//               transition duration-300 ease-in-out hover:scale-105 hover:bg-yellow-600 hover:shadow-lg cursor-pointer"
//           >
//             <FaEye size={18} />
//           </div>
//         </div>
...
//   return (
//     <div className="flex flex-col items-center justify-center mt-10 allR">
//       <h1
//         className={`${cinzel.className} antialiased text-4xl font-semibold text-black p-8`}
//       >
//         Idées de cadeaux...
...
const Section2 = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center mt-10 allR">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-4 max-w-5xl pb-20">
        <div className="col-span-1 row-span-2 relative shadow-md shadow-black">
          <img
            src={data[0].image}
            alt={data[0].name}
        ...
        <div className="col-span-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4">
          {data.slice(1, 3).map((plant, index) => (
            <div key={index} className="relative shadow-md shadow-black">
              <img
                src={plant.image}
